...
VALUES 
(31001, 'Bomber1', NULL, 'Various types of shirts'),
(31002, 'Bomber2', NULL, 'Different styles of clothing'),
(31003, 'Bomber3', NULL, 'Various designs of t-shirts'),
(31004, 'Bomber4', NULL, 'Different cuts and washes of jeans'),
(31005, 'Bomber5', NULL, 'Various colors and designs of hoodies'),
--M
(31006, 'Bomber6', NULL, 'Different types of jackets for all seasons'),
(31007, 'Bomber7', NULL, 'Various styles of dresses for different occasions'),
(31008, 'Bomber8', NULL, 'Different lengths and styles of skirts'),
(31009, 'Bomber9', NULL, 'Elegant and casual blouses for women'),
(31010, 'Bomber10', NULL, 'Cozy sweaters for chilly weather'),
--F
(31011, 'Hoodie1', NULL, 'Different lengths and styles of shorts'),
(31012, 'Hoodie2', NULL, 'Formal suits for men and women'),
(31013, 'Hoodie3', NULL, 'Various types of trousers for everyday wear'),
(31014, 'Hoodie4', NULL, 'Stylish swimwear for the beach or pool'),
(31015, 'Hoodie5', NULL, 'High-performance sportswear for athletes'),
--M
(31016, 'Hoodie6', NULL, 'Warm and stylish outerwear options'),
(31017, 'Hoodie7', NULL, 'Comfortable and functional activewear'),
(31018, 'Hoodie8', NULL, 'Comfortable and supportive underwear options'),
(31019, 'Hoodie9', NULL, 'Cozy and comfortable sleepwear options'),
(31020, 'Hoodie10', NULL, 'Various accessories to complement your outfit'),
--F
(31021, 'Sweaters1', NULL, 'Stylish and comfortable footwear options'),
(31022, 'Sweaters2', NULL, 'Elegant formalwear for special occasions'),
(31023, 'Sweaters3', NULL, 'Traditional clothing from different cultures'),
(31024, 'Sweaters4', NULL, 'Comfortable and stylish maternity clothing'),
(31025, 'Sweaters5', NULL, 'Fashionable clothing for plus-size individuals'),
--M
(31026, 'Sweaters6', NULL, 'Adorable outfits for your furry friends'),
(31027, 'Sweaters7', NULL, 'Professional uniforms for various industries'),
(31028, 'Sweaters8', NULL, 'Creative costumes for parties and events'),
(31029, 'Sweaters9', NULL, 'Unique vintage clothing pieces'),
(31030, 'Sweaters10', NULL, 'Durable and functional workwear options'),
--F
(31031, 'T-Shirt1', NULL, 'Trendy streetwear styles for urban fashionistas'),
(31032, 'T-Shirt2', NULL, 'Stylish outfits for parties and celebrations'),
(31033, 'T-Shirt3', NULL, 'Fashionable beachwear for sunny days'),
(31034, 'T-Shirt4', NULL, 'Elegant attire for weddings and ceremonies'),
(31035, 'T-Shirt5', NULL, 'Smart and relaxed business casual outfits'),
--M
(31036, 'T-Shirt6', NULL, 'Comfortable and breathable gym wear'),
(31037, 'T-Shirt7', NULL, 'Relaxing loungewear for lazy days at home'),
(31038, 'T-Shirt8', NULL, 'Functional clothing for outdoor adventures'),
(31039, 'T-Shirt9', NULL, 'Stylish outfits for nights out on the town'),
(31040, 'T-Shirt10', NULL, 'Sophisticated yet relaxed formal casual attire');
--F
